...
const STRINGS = {
  ...
  weeklyReportTitle: { en: "Weekly Report", es: "Informe Semanal" },
  printButton: { en: "Print", es: "Imprimir" },
  weeklyReportSummaryLine: {
    en: "{done} of {total} stores fully compliant · {flagged} flagged items · {repeat} repeat violations · {aiFlags} automated flags",
    es: "{done} de {total} tiendas totalmente cumplidas · {flagged} artículos marcados · {repeat} violaciones repetidas · {aiFlags} marcas automáticas",
  },
  weeklyReportNoData: { en: "Nothing to report this week.", es: "Nada que informar esta semana." },
  weeklyReportCompletionSection: { en: "Store Completion", es: "Cumplimiento por Tienda" },
  weeklyReportTrendingSection: { en: "Trending Violations — Multiple Stores", es: "Violaciones en Tendencia — Varias Tiendas" },
  weeklyReportTrendingStores: { en: "{count} stores", es: "{count} tiendas" },
  weeklyReportRepeatSection: { en: "Repeat Violations by Store", es: "Violaciones Repetidas por Tienda" },
  weeklyReportAllFlaggedSection: { en: "All Flagged Items", es: "Todos los Artículos Marcados" },
  weeklyReportAiFlagsSection: { en: "Automated Photo Flags", es: "Marcas Automáticas de Fotos" },
  weeklyReportMismatchSectionLabel: { en: "Temperature Mismatches", es: "Discrepancias de Temperatura" },
