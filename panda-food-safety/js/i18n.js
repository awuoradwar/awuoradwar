...
const STRINGS = {
  ...
  actionPlanLabel: { en: "Action plan", es: "Plan de acción" },
  actionPlanPlaceholder: { en: "Describe the action plan to fix this", es: "Describa el plan de acción para corregir esto" },
