...
const STRINGS = {
  ...
  aiFlagsButtonLabel: { en: "AI flags", es: "Alertas de IA" },
  aiFlagsModalTitle: { en: "AI Temperature Flags", es: "Alertas de Temperatura de IA" },
  aiFlagsModalHint: { en: "The photo attached to these items appears to disagree with the answer given. Automated reads can be wrong — always check the photo yourself before acting.", es: "La foto adjunta a estos elementos parece no coincidir con la respuesta dada. Las lecturas automáticas pueden estar equivocadas — siempre revise la foto usted mismo antes de actuar." },
  noAiFlags: { en: "No unresolved AI flags.", es: "No hay alertas de IA sin resolver." },
  ...
  aiMismatchBadge: { en: "🤖 reads ~{temp}°F", es: "🤖 muestra ~{temp}°F" },
  aiFlagReasonUnreadable: { en: "🤖 Photo doesn't clearly show what's asked", es: "🤖 La foto no muestra claramente lo solicitado" },
  aiFlagReasonDuplicate: { en: "🤖 Matches a photo already used on {date}", es: "🤖 Coincide con una foto ya usada el {date}" },
  aiFlagUnreadableDetail: { en: "The attached photo doesn't show a clear reading — could be blank, blurry, or the wrong subject.", es: "La foto adjunta no muestra una lectura clara — podría estar en blanco, borrosa, o ser el objeto equivocado." },
  aiFlagDuplicateDetail: { en: "This photo appears identical to one already submitted for this store on {date}.", es: "Esta foto parece idéntica a una ya enviada para esta tienda el {date}." },
};
