...
const es: Record<DictKeys, string> = {
  ...
  more_procedures: "Procedimientos de Apertura/Cierre",
  ...
  store_profile_cogs_pct: "COGS Real %",
  store_profile_cogs_theoretical_pct: "COGS Teórico %",
  ...
  store_profile_restaurant_contribution_pct: "Contribución del Restaurante % (RC)",
